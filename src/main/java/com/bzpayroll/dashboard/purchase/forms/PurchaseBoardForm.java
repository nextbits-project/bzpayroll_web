...
public class PurchaseBoardForm {
	...
	/**
	 * @param addressID The bSAddressID to set.
	 */
	...
	/**
	 * @param estNum The estNum to set.
	 */
	...
	/**
	 * @param filterMarket The filterMarket to set.
	 */
	...
	/**
	 * @param isEmailed The isEmailed to set.
	 */
	...
	/**
	 * @param orderDate1 The orderDate1 to set.
	 */
	...
	/**
	 * @param orderDate2 The orderDate2 to set.
	 */
	...
	/**
	 * @param rcvNum The rcvNum to set.
	 */
	...
	/**
	 * @param saleDate1 The saleDate1 to set.
	 */
	...
	/**
	 * @param saleDate2 The saleDate2 to set.
	 */
	...
	/**
	 * @param sortType1 The sortType1 to set.
	 */
	...
	/**
	 * @param sortType2 The sortType2 to set.
	 */
