...
public class InvoiceDto {
	...
	/**
	 * @param adjustedtotal the adjustedtotal to set
	 */
	 ...
	 * =request.getParameter("orderNo"); String pNum =request.getParameter("poNum");
	 * String wgt=request.getParameter("weight"); String
	 ...
	 * ActionMessage("InvoiceForm.OrderNo.Problem")); } /*if(!(v.isNumber(ordNo))){
	 * errors.add("ordNo", new ActionMessage("Order
	 ...
	 * SalesDetails details = new SalesDetails(); details.getInvoiceInfo(request);
	 * return errors; }
	 */
}
