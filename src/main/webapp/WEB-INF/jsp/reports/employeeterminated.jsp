...
<form:form action="/dashboard/Reports?tabid=Terminated" method="post" id="salesboardForm" name="salesboardForm"  modelAttribute="salesBoardDto" >
...
<div id="printContent">
	<div id="headerBar">
	      ...
	      <h6 style="text-align: center;color: blue;" id="headerBarValue"><spring:message code="BzComposer.employee.terminatedemployeelist"/></h6>
	</div>
...
function search()
{
	document.forms[0].action = "/dashboard/Reports?tabid=Terminated";
